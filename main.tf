...
resource "aws_elb" "web" {
  ...
  # “select the first element in the var.public_subnet_ids and know we're getting the 10.0.1.0/24 subnet and so on.”
...
# creates a DNS record—in our case a CNAME record
